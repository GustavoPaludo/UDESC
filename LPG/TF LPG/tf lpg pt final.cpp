...
struct filme* le_filme(struct filme *p,int *aux){
    ...
    while(p[*aux-1].duracao<0 || p[*aux-1].duracao>999){
        printf("Valor de duração inválido. Digite novamente: ");
      scanf("%d",&p[*aux-1].duracao);  
    }
    ...
    while(p[*aux-1].dia<1 || p[*aux-1].dia>31){
        printf("Valor de dia inválido. Digite novamente: ");
          scanf("%d",&p[*aux-1].dia);  
    }
    printf("Digite o mes atual (mm): \n");
    scanf("%d", &p[*aux-1].mes );
    while(p[*aux-1].mes<1 || p[*aux-1].mes>12){
        printf("Valor de mês inválido. Digite novamente: ");
          scanf("%d",&p[*aux-1].mes);  
    }
    printf("Digite o ano atual (aaaa): \n");
    scanf("%d", &p[*aux-1].ano );
    while(p[*aux-1].ano<0 || p[*aux-1].ano>9999){
        printf("Valor de ano inválido. Digite novamente: ");
          scanf("%d",&p[*aux-1].ano);  
    }
